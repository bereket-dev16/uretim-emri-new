  ...
  return (
    <div className="page-shell space-y-4">
      <PageIntro
        ...
        description="İş emri bilgilerini girin, operasyon notunu ekleyin ve gerekiyorsa hammadde ile makine görevlerini birlikte başlatın. Ek alanında yalnız sürükle-bırak veya kopyala-yapıştır ile görsel kabul edilir."
        actions={
      ...
      <SectionPanel title="Yeni Emir" description="Önizleme onayından sonra hammadde görevi açılır; makine seçildiyse aynı anda ilk makine görevi de başlatılır. Ek görseller dosya seçmeden, doğrudan alana bırakılarak veya yapıştırılarak alınır.">
